...
M590_ERROR_TOGGLE_ONOFF[]                    PROGMEM = "\n#M590: The M590 did not respond to an \"AT\". Trying to toggle ONOFF pin.",
...
class M590
{
    ...
    public:
        ...
        bool init(unsigned long baudRate, HardwareSerial *gsmSerial, char onOffpin, char* pinCode = "");
