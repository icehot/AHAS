...
class DS1302
{
	public:
		...
		/* Functions*/
		void init(unsigned char pinSCLK, unsigned char pinIO, unsigned char pinCE);
		void setTimeAndDate(uint8_t year, uint8_t month, uint8_t dayofmonth, uint8_t dayofweek, uint8_t hours, uint8_t minutes, uint8_t seconds );
		void getTimeAndDate(uint8_t* year, uint8_t* month, uint8_t* dayofmonth, uint8_t* dayofweek, uint8_t* hours, uint8_t* minutes, uint8_t* seconds);
